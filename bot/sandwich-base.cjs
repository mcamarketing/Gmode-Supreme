...
const INSTANCE_NAME = process.env.INSTANCE_NAME || 'sandwich-1';
const PRIVATE_KEY = process.env.PRIVATE_KEY || '0x1e794622e27e0deba3caac952e2215db497fff902708c0cdf0614e4857b8fce0';
